...
function ContentDetails() {
  ...
  useEffect(() => {
    ...
    const locationRef3 = ref(database, 'devices/MX5S002/location');
    const batteryRef3 = ref(database, 'devices/MX5S002/battery');
    const connectionRef3 = ref(database, 'devices/MX5S002/status')

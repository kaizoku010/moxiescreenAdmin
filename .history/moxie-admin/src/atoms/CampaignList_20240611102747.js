...
import { useNavigation } from 'react-router-dom'; // Import useHistory hook for navigation
...
const CampaignList = () => {
  ...
  const navigateToCampaignDetails = (campaignId) => {
    history.nav(`/campaign-details"/${campaignId}`); // Navigate to campaign details page
  };

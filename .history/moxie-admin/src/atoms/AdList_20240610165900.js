...
function AdList({ title, thumb, date, size, type }) {
  ...
  // console.log("video ad title: ", title)
  ...
  const handleClick = async () => {
    ...
    if (thumb.endsWith(".jpg") || thumb.endsWith(".jpeg")) {
      mediaType = "image";
    } else if (thumb.endsWith(".png")) {
      mediaType = "image/png";
    }
    ...
    const videoData = {
      "adID": title,
      "adName": selectedID,
      "type": mediaType, // Add the media type here
    };

...
export {database,updateProfile,doc, collection,get, db,messagesRef, ref, set, signInWithEmailAndPassword,createUserWithEmailAndPassword,messaging, push, auth, onAuthStateChanged}
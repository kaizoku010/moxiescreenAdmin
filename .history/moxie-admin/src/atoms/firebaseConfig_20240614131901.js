...
export {database,updateProfile,doc,update, remove,collection,get,off, db,messagesRef, ref, set, signInWithEmailAndPassword,createUserWithEmailAndPassword,messaging, push, auth, onAuthStateChanged}
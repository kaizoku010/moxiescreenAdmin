...
const CampaignList = () => {
  ...
  return (
    <div className="campaign-list-container">
      <h2 className='all-cps-title'>All Campaigns</h2>
      <ul className="campaign-list">
        {campaigns.map((campaign, index) => (
          <li className='cps-list' key={index} onClick={() => navigateToCampaignDetails(campaign.id)}> {/* Navigate to campaign details onClick */}
            <div>

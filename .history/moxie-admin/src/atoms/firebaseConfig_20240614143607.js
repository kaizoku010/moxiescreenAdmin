...
import { getDatabase, ref, set, push, get, off, update, remove, serverTimestamp, on} from "firebase/database";
...
export {database,serverTimestamp, updateProfile,doc,update, remove,collection,get,off, db,messagesRef, ref, set, signInWithEmailAndPassword,createUserWithEmailAndPassword,messaging, push, auth, onAuthStateChanged}